...
public:
    ...
    // @param local On platforms that have more than one application data directory,
    //        setting this to true will return the local or internal data directory.
    KDUtils::Dir applicationDataDir(bool local = false) const;
