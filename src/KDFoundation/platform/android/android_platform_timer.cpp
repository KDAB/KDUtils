...
#include <KDFoundation/platform/android/android_platform_timer.h>
...
AndroidPlatformTimer::AndroidPlatformTimer(Timer *timer)
...
AndroidPlatformTimer::FdCloser::~FdCloser()
{
    close(fd);
}

void AndroidPlatformTimer::arm(std::chrono::microseconds us)
{
    timespec time;
...
void AndroidPlatformTimer::disarm()
{
