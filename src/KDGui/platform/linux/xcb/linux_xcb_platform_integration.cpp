...
KDUtils::Dir LinuxXcbPlatformIntegration::applicationDataDir(const KDFoundation::CoreApplication &app, bool) const
{
    return KDUtils::Dir(KDFoundation::LinuxPlatformIntegration::linuxAppDataPath(app));
}

KDUtils::Dir LinuxXcbPlatformIntegration::assetsDataDir(const KDFoundation::CoreApplication &) const
{
